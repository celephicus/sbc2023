...
int main(int argc, char** argv) {
  ...
  do_run_test(testUtilsQueuePut_stub_3, "testUtilsQueuePut(queueQPut, 0, 0, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_4, "testUtilsQueuePut(queueQPut, 0, 1, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_5, "testUtilsQueuePut(queueQPut, 0, 2, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_6, "testUtilsQueuePut(queueQPut, 0, 3, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_7, "testUtilsQueuePut(queueQPut, 0, 4, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_8, "testUtilsQueuePut(queueQPut, 1, 0, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_9, "testUtilsQueuePut(queueQPut, 1, 1, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_10, "testUtilsQueuePut(queueQPut, 1, 2, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_11, "testUtilsQueuePut(queueQPut, 1, 3, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_12, "testUtilsQueuePut(queueQPut, 1, 4, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_13, "testUtilsQueuePut(queueQPut, 2, 0, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_14, "testUtilsQueuePut(queueQPut, 2, 1, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_15, "testUtilsQueuePut(queueQPut, 2, 2, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_16, "testUtilsQueuePut(queueQPut, 2, 3, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_17, "testUtilsQueuePut(queueQPut, 2, 4, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_18, "testUtilsQueuePut(queueQPut, 3, 0, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_19, "testUtilsQueuePut(queueQPut, 3, 1, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_20, "testUtilsQueuePut(queueQPut, 3, 2, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_21, "testUtilsQueuePut(queueQPut, 3, 3, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_22, "testUtilsQueuePut(queueQPut, 3, 4, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_23, "testUtilsQueuePut(queueQPut, 4, 0, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_24, "testUtilsQueuePut(queueQPut, 4, 1, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_25, "testUtilsQueuePut(queueQPut, 4, 2, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_26, "testUtilsQueuePut(queueQPut, 4, 3, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_27, "testUtilsQueuePut(queueQPut, 4, 4, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_28, "testUtilsQueuePut(queueQPut, 5, 0, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_29, "testUtilsQueuePut(queueQPut, 5, 1, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_30, "testUtilsQueuePut(queueQPut, 5, 2, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_31, "testUtilsQueuePut(queueQPut, 5, 3, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_32, "testUtilsQueuePut(queueQPut, 5, 4, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_33, "testUtilsQueuePut(queueQPut, 254, 0, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_34, "testUtilsQueuePut(queueQPut, 254, 1, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_35, "testUtilsQueuePut(queueQPut, 254, 2, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_36, "testUtilsQueuePut(queueQPut, 254, 3, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_37, "testUtilsQueuePut(queueQPut, 254, 4, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_38, "testUtilsQueuePut(queueQPut, 255, 0, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_39, "testUtilsQueuePut(queueQPut, 255, 1, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_40, "testUtilsQueuePut(queueQPut, 255, 2, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_41, "testUtilsQueuePut(queueQPut, 255, 3, 10, 1)", 91);
  do_run_test(testUtilsQueuePut_stub_42, "testUtilsQueuePut(queueQPut, 255, 4, 10, 1)", 91);
  do_run_test(testUtilsQueuePutOvf_stub_43, "testUtilsQueuePutOvf(queueQPut, 0, 10, 1)", 98);
  do_run_test(testUtilsQueuePutOvf_stub_44, "testUtilsQueuePutOvf(queueQPut, 1, 10, 1)", 98);
  do_run_test(testUtilsQueuePutOvf_stub_45, "testUtilsQueuePutOvf(queueQPut, 2, 10, 1)", 98);
  do_run_test(testUtilsQueuePutOvf_stub_46, "testUtilsQueuePutOvf(queueQPut, 3, 10, 1)", 98);
  do_run_test(testUtilsQueuePutOvf_stub_47, "testUtilsQueuePutOvf(queueQPut, 4, 10, 1)", 98);
  do_run_test(testUtilsQueuePutOvf_stub_48, "testUtilsQueuePutOvf(queueQPut, 5, 10, 1)", 98);
  do_run_test(testUtilsQueuePutOvf_stub_49, "testUtilsQueuePutOvf(queueQPut, 254, 10, 1)", 98);
  do_run_test(testUtilsQueuePutOvf_stub_50, "testUtilsQueuePutOvf(queueQPut, 255, 10, 1)", 98);
  do_run_test(testUtilsQueuePut_stub_51, "testUtilsQueuePut(queueQPush, 0, 0, 9, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_52, "testUtilsQueuePut(queueQPush, 0, 1, 10, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_53, "testUtilsQueuePut(queueQPush, 0, 2, 11, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_54, "testUtilsQueuePut(queueQPush, 0, 3, 12, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_55, "testUtilsQueuePut(queueQPush, 0, 4, 13, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_56, "testUtilsQueuePut(queueQPush, 1, 0, 9, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_57, "testUtilsQueuePut(queueQPush, 1, 1, 10, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_58, "testUtilsQueuePut(queueQPush, 1, 2, 11, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_59, "testUtilsQueuePut(queueQPush, 1, 3, 12, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_60, "testUtilsQueuePut(queueQPush, 1, 4, 13, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_61, "testUtilsQueuePut(queueQPush, 2, 0, 9, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_62, "testUtilsQueuePut(queueQPush, 2, 1, 10, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_63, "testUtilsQueuePut(queueQPush, 2, 2, 11, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_64, "testUtilsQueuePut(queueQPush, 2, 3, 12, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_65, "testUtilsQueuePut(queueQPush, 2, 4, 13, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_66, "testUtilsQueuePut(queueQPush, 3, 0, 9, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_67, "testUtilsQueuePut(queueQPush, 3, 1, 10, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_68, "testUtilsQueuePut(queueQPush, 3, 2, 11, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_69, "testUtilsQueuePut(queueQPush, 3, 3, 12, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_70, "testUtilsQueuePut(queueQPush, 3, 4, 13, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_71, "testUtilsQueuePut(queueQPush, 4, 0, 9, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_72, "testUtilsQueuePut(queueQPush, 4, 1, 10, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_73, "testUtilsQueuePut(queueQPush, 4, 2, 11, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_74, "testUtilsQueuePut(queueQPush, 4, 3, 12, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_75, "testUtilsQueuePut(queueQPush, 4, 4, 13, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_76, "testUtilsQueuePut(queueQPush, 5, 0, 9, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_77, "testUtilsQueuePut(queueQPush, 5, 1, 10, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_78, "testUtilsQueuePut(queueQPush, 5, 2, 11, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_79, "testUtilsQueuePut(queueQPush, 5, 3, 12, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_80, "testUtilsQueuePut(queueQPush, 5, 4, 13, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_81, "testUtilsQueuePut(queueQPush, 254, 0, 9, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_82, "testUtilsQueuePut(queueQPush, 254, 1, 10, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_83, "testUtilsQueuePut(queueQPush, 254, 2, 11, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_84, "testUtilsQueuePut(queueQPush, 254, 3, 12, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_85, "testUtilsQueuePut(queueQPush, 254, 4, 13, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_86, "testUtilsQueuePut(queueQPush, 255, 0, 9, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_87, "testUtilsQueuePut(queueQPush, 255, 1, 10, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_88, "testUtilsQueuePut(queueQPush, 255, 2, 11, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_89, "testUtilsQueuePut(queueQPush, 255, 3, 12, -1)", 109);
  do_run_test(testUtilsQueuePut_stub_90, "testUtilsQueuePut(queueQPush, 255, 4, 13, -1)", 109);
  do_run_test(testUtilsQueuePutOvf_stub_91, "testUtilsQueuePutOvf(queueQPush, 0, 13, -1)", 116);
  do_run_test(testUtilsQueuePutOvf_stub_92, "testUtilsQueuePutOvf(queueQPush, 1, 13, -1)", 116);
  do_run_test(testUtilsQueuePutOvf_stub_93, "testUtilsQueuePutOvf(queueQPush, 2, 13, -1)", 116);
  do_run_test(testUtilsQueuePutOvf_stub_94, "testUtilsQueuePutOvf(queueQPush, 3, 13, -1)", 116);
  do_run_test(testUtilsQueuePutOvf_stub_95, "testUtilsQueuePutOvf(queueQPush, 4, 13, -1)", 116);
  do_run_test(testUtilsQueuePutOvf_stub_96, "testUtilsQueuePutOvf(queueQPush, 5, 13, -1)", 116);
  do_run_test(testUtilsQueuePutOvf_stub_97, "testUtilsQueuePutOvf(queueQPush, 254, 13, -1)", 116);
  do_run_test(testUtilsQueuePutOvf_stub_98, "testUtilsQueuePutOvf(queueQPush, 255, 13, -1)", 116);
  do_run_test(testUtilsQueuePutLifo_stub_99, "testUtilsQueuePutLifo(0, 0)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_100, "testUtilsQueuePutLifo(0, 1)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_101, "testUtilsQueuePutLifo(0, 2)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_102, "testUtilsQueuePutLifo(0, 3)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_103, "testUtilsQueuePutLifo(1, 0)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_104, "testUtilsQueuePutLifo(1, 1)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_105, "testUtilsQueuePutLifo(1, 2)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_106, "testUtilsQueuePutLifo(1, 3)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_107, "testUtilsQueuePutLifo(2, 0)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_108, "testUtilsQueuePutLifo(2, 1)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_109, "testUtilsQueuePutLifo(2, 2)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_110, "testUtilsQueuePutLifo(2, 3)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_111, "testUtilsQueuePutLifo(3, 0)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_112, "testUtilsQueuePutLifo(3, 1)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_113, "testUtilsQueuePutLifo(3, 2)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_114, "testUtilsQueuePutLifo(3, 3)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_115, "testUtilsQueuePutLifo(4, 0)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_116, "testUtilsQueuePutLifo(4, 1)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_117, "testUtilsQueuePutLifo(4, 2)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_118, "testUtilsQueuePutLifo(4, 3)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_119, "testUtilsQueuePutLifo(5, 0)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_120, "testUtilsQueuePutLifo(5, 1)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_121, "testUtilsQueuePutLifo(5, 2)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_122, "testUtilsQueuePutLifo(5, 3)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_123, "testUtilsQueuePutLifo(254, 0)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_124, "testUtilsQueuePutLifo(254, 1)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_125, "testUtilsQueuePutLifo(254, 2)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_126, "testUtilsQueuePutLifo(254, 3)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_127, "testUtilsQueuePutLifo(255, 0)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_128, "testUtilsQueuePutLifo(255, 1)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_129, "testUtilsQueuePutLifo(255, 2)", 139);
  do_run_test(testUtilsQueuePutLifo_stub_130, "testUtilsQueuePutLifo(255, 3)", 139);
  do_run_test(testUtilsQueuePutOverwrite_stub_131, "testUtilsQueuePutOverwrite(0, 0)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_132, "testUtilsQueuePutOverwrite(0, 1)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_133, "testUtilsQueuePutOverwrite(0, 2)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_134, "testUtilsQueuePutOverwrite(0, 3)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_135, "testUtilsQueuePutOverwrite(0, 4)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_136, "testUtilsQueuePutOverwrite(0, 5)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_137, "testUtilsQueuePutOverwrite(0, 6)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_138, "testUtilsQueuePutOverwrite(1, 0)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_139, "testUtilsQueuePutOverwrite(1, 1)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_140, "testUtilsQueuePutOverwrite(1, 2)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_141, "testUtilsQueuePutOverwrite(1, 3)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_142, "testUtilsQueuePutOverwrite(1, 4)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_143, "testUtilsQueuePutOverwrite(1, 5)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_144, "testUtilsQueuePutOverwrite(1, 6)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_145, "testUtilsQueuePutOverwrite(2, 0)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_146, "testUtilsQueuePutOverwrite(2, 1)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_147, "testUtilsQueuePutOverwrite(2, 2)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_148, "testUtilsQueuePutOverwrite(2, 3)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_149, "testUtilsQueuePutOverwrite(2, 4)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_150, "testUtilsQueuePutOverwrite(2, 5)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_151, "testUtilsQueuePutOverwrite(2, 6)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_152, "testUtilsQueuePutOverwrite(3, 0)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_153, "testUtilsQueuePutOverwrite(3, 1)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_154, "testUtilsQueuePutOverwrite(3, 2)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_155, "testUtilsQueuePutOverwrite(3, 3)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_156, "testUtilsQueuePutOverwrite(3, 4)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_157, "testUtilsQueuePutOverwrite(3, 5)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_158, "testUtilsQueuePutOverwrite(3, 6)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_159, "testUtilsQueuePutOverwrite(4, 0)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_160, "testUtilsQueuePutOverwrite(4, 1)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_161, "testUtilsQueuePutOverwrite(4, 2)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_162, "testUtilsQueuePutOverwrite(4, 3)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_163, "testUtilsQueuePutOverwrite(4, 4)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_164, "testUtilsQueuePutOverwrite(4, 5)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_165, "testUtilsQueuePutOverwrite(4, 6)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_166, "testUtilsQueuePutOverwrite(5, 0)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_167, "testUtilsQueuePutOverwrite(5, 1)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_168, "testUtilsQueuePutOverwrite(5, 2)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_169, "testUtilsQueuePutOverwrite(5, 3)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_170, "testUtilsQueuePutOverwrite(5, 4)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_171, "testUtilsQueuePutOverwrite(5, 5)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_172, "testUtilsQueuePutOverwrite(5, 6)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_173, "testUtilsQueuePutOverwrite(254, 0)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_174, "testUtilsQueuePutOverwrite(254, 1)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_175, "testUtilsQueuePutOverwrite(254, 2)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_176, "testUtilsQueuePutOverwrite(254, 3)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_177, "testUtilsQueuePutOverwrite(254, 4)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_178, "testUtilsQueuePutOverwrite(254, 5)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_179, "testUtilsQueuePutOverwrite(254, 6)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_180, "testUtilsQueuePutOverwrite(255, 0)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_181, "testUtilsQueuePutOverwrite(255, 1)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_182, "testUtilsQueuePutOverwrite(255, 2)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_183, "testUtilsQueuePutOverwrite(255, 3)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_184, "testUtilsQueuePutOverwrite(255, 4)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_185, "testUtilsQueuePutOverwrite(255, 5)", 165);
  do_run_test(testUtilsQueuePutOverwrite_stub_186, "testUtilsQueuePutOverwrite(255, 6)", 165);
  ...
  do_run_test(testBufferAddChar_stub_187, "testBufferAddChar(1)", 211);
  do_run_test(testBufferAddChar_stub_188, "testBufferAddChar(TEST_UTILS_BUF_SIZE-1)", 212);
  do_run_test(testBufferAddChar_stub_189, "testBufferAddChar(TEST_UTILS_BUF_SIZE)", 213);
  do_run_test(testBufferAddCharOverflow, "testBufferAddCharOverflow", 215);
  do_run_test(testBufferAddU16_stub_190, "testBufferAddU16(1)", 240);
  do_run_test(testBufferAddU16_stub_191, "testBufferAddU16(TEST_UTILS_BUF_SIZE/2-1)", 241);
  do_run_test(testBufferAddU16_stub_192, "testBufferAddU16(TEST_UTILS_BUF_SIZE/2)", 242);
  ...
  do_run_test(testUtilsStrtoui_stub_193, "testUtilsStrtoui(\"\", 0, 10, false, 0, '\\0')", 302);
  do_run_test(testUtilsStrtoui_stub_194, "testUtilsStrtoui(\"*\", 0,  10, false, 0, '*')", 303);
  do_run_test(testUtilsStrtoui_stub_195, "testUtilsStrtoui(\"9\", 0,  10, true, 9, '\\0')", 305);
  do_run_test(testUtilsStrtoui_stub_196, "testUtilsStrtoui(\"1\", 0,  2, true, 1, '\\0')", 306);
  do_run_test(testUtilsStrtoui_stub_197, "testUtilsStrtoui(\"f\", 0,  16, true, 15, '\\0')", 307);
  do_run_test(testUtilsStrtoui_stub_198, "testUtilsStrtoui(\"F\", 0,  16, true, 15, '\\0')", 308);
  do_run_test(testUtilsStrtoui_stub_199, "testUtilsStrtoui(\"z\", 0,  36, true, 35, '\\0')", 309);
  do_run_test(testUtilsStrtoui_stub_200, "testUtilsStrtoui(\"Z\", 0,  36, true, 35, '\\0')", 310);
  do_run_test(testUtilsStrtoui_stub_201, "testUtilsStrtoui(\"+9\", 0,  10, true, 9, '\\0')", 312);
  do_run_test(testUtilsStrtoui_stub_202, "testUtilsStrtoui(\" 9\", 0,  10, true, 9, '\\0')", 313);
  do_run_test(testUtilsStrtoui_stub_203, "testUtilsStrtoui(\"09\", 0,  10, true, 9, '\\0')", 314);
  do_run_test(testUtilsStrtoui_stub_204, "testUtilsStrtoui(\"%lu\", UINT_MAX,  10, true, UINT_MAX, '\\0')", 316);
  do_run_test(testUtilsStrtoui_stub_205, "testUtilsStrtoui(\"%lx\", UINT_MAX,  16, true, UINT_MAX, '\\0')", 317);
  do_run_test(testUtilsStrtoui_stub_206, "testUtilsStrtoui(\"%lu\", (unsigned long)UINT_MAX+1,  10, false, 0, '\\0')", 319);
  do_run_test(testUtilsStrtoui_stub_207, "testUtilsStrtoui(\"%lx\", (unsigned long)UINT_MAX+1,  16, false, 0, '\\0')", 320);
  do_run_test(testUtilsStrtoui_stub_208, "testUtilsStrtoui(\"9a\", 0,  10, true, 9, 'a')", 322);
  do_run_test(testUtilsStrtoui_stub_209, "testUtilsStrtoui(\"a\", 0,  10, false, 0, 'a')", 323);
  registerFixture(NULL, NULL, NULL);
