...
/* Function called at end of debugRuntimeError(). 
	Can be used to write a message to a display or can never return  and toggle a LED with a delay, in which case it should kick the watchdog.
