...
enum {
    ...
    EV_FOOBLE = 8,                      // Foos the bar.
    EV_SCANNER_12V_IN_UNDERVOLT = 9,    // DC power in volts low.
    EV_SCANNER_BUS_UNDERVOLT = 10,      // Bus volts low.
    EV_MODBUS_MASTER_COMMS = 11,        // Request from MODBUS master received, used for comms timeout.
...
#define DECLARE_EVENT_NAME()                                                            \
 ...
 static const char EVENT_NAME_8[] PROGMEM = "FOOBLE";                                   \
 static const char EVENT_NAME_9[] PROGMEM = "SCANNER_12V_IN_UNDERVOLT";                 \
 static const char EVENT_NAME_10[] PROGMEM = "SCANNER_BUS_UNDERVOLT";                   \
 static const char EVENT_NAME_11[] PROGMEM = "MODBUS_MASTER_COMMS";                     \
                                                                                        \
...
#define DECLARE_EVENT_DESC()                                                                                                                \
 ...
 static const char EVENT_DESC_8[] PROGMEM = "Foos the bar.";                                                                                \
 static const char EVENT_DESC_9[] PROGMEM = "DC power in volts low.";                                                                       \
 static const char EVENT_DESC_10[] PROGMEM = "Bus volts low.";                                                                              \
 static const char EVENT_DESC_11[] PROGMEM = "Request from MODBUS master received, used for comms timeout.";                                \
                                                                                                                                            \
