...
enum {
	...
	APP_CMD_STATUS_OK_DURING_PENDING = 11,	// Some commands can run successfully during a pending command, so they return this code. But the APP_CMD_STATUS_OK code is returned to the clients. 
